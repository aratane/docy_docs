...
function docy_import_files() {
	return array(
		...
		array(
			...
			'local_import_file'        => trailingslashit( get_template_directory() ) . 'inc/demo/contents.xml',
			'local_import_widget_file' => trailingslashit( get_template_directory() ) . 'inc/demo/widgets.wie',
			'import_preview_image_url' => trailingslashit( get_template_directory_uri() ) . 'inc/demo/images/docy-user-manuals.jpg',
		...
		array(
			...
			'local_import_file'        => trailingslashit( get_template_directory() ) . 'inc/demo/contents.xml',
			'local_import_widget_file' => trailingslashit( get_template_directory() ) . 'inc/demo/widgets.wie',
			'import_preview_image_url' => trailingslashit( get_template_directory_uri() ) . 'inc/demo/images/docy-focused-helpdesk.jpg',
...
function docy_after_import_setup( $selected_import ) {
	...
	if ( 'Support Forum' == $selected_import['import_file_name'] ) {
		$front_page_id = get_page_by_title( 'Support Forum' );
	}

	if ( 'Multi Helpdesk' == $selected_import['import_file_name'] ) {
		$front_page_id = get_page_by_title( 'Home Multi Helpdesk' );
	}

	if ( 'Book Chapters / Tutorials' == $selected_import['import_file_name'] ) {
		$front_page_id = get_page_by_title( 'Home Book Chapters / Tutorials' );
	}

	if ( 'User Manuals' == $selected_import['import_file_name'] ) {
		$front_page_id = get_page_by_title( 'User Manuals' );
	}

	if ( 'Focused Helpdesk' == $selected_import['import_file_name'] ) {
		$front_page_id = get_page_by_title( 'Focused Helpdesk' );
	}
