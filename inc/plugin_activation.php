...
function docy_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'          => esc_html__( 'Redux Framework', 'docy' ),
        ...
        array(
            'name'          => esc_html__( 'Contact Form 7', 'docy' ),
            'slug'          => 'contact-form-7',
            'required'      => false,
        ),
        ...
        array(
            ...
            'source'        => get_template_directory().'/inc/tgm/smart-bbpress-nverify.zip', // The plugin source.
            'required'      => false,
        ),
	);
