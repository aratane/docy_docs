...
$bg_image = !empty($opt['sbnr_bg_image2']['url']) ? "style='background: url(".esc_url($opt['sbnr_bg_image2']['url']).") no-repeat fixed center; background-size: cover;'" : '';
...
<section class="sbnr-aesthetic sbnr-global" <?php echo $bg_image ?>>
    <?php
    ...
    <div class="container custom_container">
        <form action="<?php echo esc_url(home_url('/')) ?>" role="search" method="get" class="banner_search_form <?php echo esc_attr($is_focus_search) ?>">
            <div class="input-group">
                ...
                <input type="search" id="searchInput" class="form-control" name="<?php echo esc_attr($search_name) ?>"
                       onkeyup="fetchResults()" placeholder="<?php echo esc_attr($placeholder) ?>">
