    ...
    <div class="cart_title">
        <div class="row">
            <div class="col-md-5 col-4">
                <h6 class="f_p"> <?php esc_html_e( 'PRODUCT', 'docy' ) ?> </h6>
            </div>
            <div class="col-md-2 col-3">
                <h6 class="f_p"> <?php esc_html_e( 'PRICE', 'docy' ) ?> </h6>
            </div>
            <div class="col-md-2 col-3">
                <h6 class="f_p"> <?php esc_html_e( 'QUANTITY', 'docy' ) ?> </h6>
            </div>
            <div class="col-md-3 col-2">
                <h6 class="f_p"> <?php esc_html_e( 'TOTAL', 'docy' ) ?> </h6>
            </div>
        </div>
    </div>
            ...
            <table class="row table cart_table mb-0 shop_table_responsive woocommerce-cart-form__contents">
                ...
                $product_id = apply_filters( 'woocommerce_cart_item_product_id', $cart_item['product_id'], $cart_item, $cart_item_key );
                    ...
                    if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                        ...
                        ?>
                        <tr>
                            <td class="product col-lg-5 col-md-5  <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>" data-title="<?php esc_attr_e( 'PRODUCT', 'docy' ) ?>">
                                <div class="media">
                            ...
                            <td class="col-lg-2 col-md-2 col-sm-12 col-xs-12 crat-price " data-title="<?php esc_attr_e( 'PRICE', 'docy' ) ?>">
                            ...
                            <td class="col-lg-2 col-md-2 cart-quantity" data-title="<?php esc_attr_e( 'QUANTITY', 'docy' ) ?>">
                                <div class="quantity">
                            ...
                            <td class="col-lg-3 col-md-3 cart-total " data-title="<?php esc_attr_e( 'TOTAL', 'docy' ) ?>">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-6 actions">
                <div class="shopping_cart_area">
                    <a href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ) ?>" class="cart_btn"> <?php esc_html_e( 'Continue Shopping', 'docy' ) ?> </a>
